...
const linklogo = 'https://quiz.edu.vn/public/temp/fables-master/assets/custom/images/fables-logo.png'
export default function Footer() {
  return (
    <>
      <div className={`${styles['fables-footer-image']} fables-after-overlay white-color py-4 py-lg-5 bg-rules`}>
          ...
          <div className="row">
            ...
            <div className="col-12 col-lg-4 mb-4 mb-lg-0">
              <a href="#" className="fables-second-border-color border-bottom pb-3 d-block mb-3 mt-minus-13">
                {/* <Image width='112' height='39' src={linklogo} alt="fables template" /> */}
              </a>
